...
class HostInfo(object):
    ...
    def __init__(self):
        self.name_server = ['openstack-swift-proxy', 'openstack-swift-object',
                            'openstack-swift-object-replicator',
                            'openstack-swift-object-updater', 'openstack-swift-object-auditor',
                            ...
                            'openstack-swift-account-reaper', 'openstack-swift-account-auditor']
    ...
    def read_ip(self):
        ...
        for i in self.x:
            ...
            if k.has_key(2) and len(k[2]) != 0 and k[2][0].has_key('addr'):
                z = k[2][0]['addr']
            else:
                continue
